#
# ISCO: Recipe adapted from
# https://github.com/openembedded/meta-oe/tree/master/meta-oe/recipes-connectivity/zeromq
#
...
# Tests enabled with IMAGE_FEATURES += "ptest-pkgs"
do_install_ptest () {
